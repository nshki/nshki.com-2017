...
(function() {
  ...
  function initGfx() {
    ...
    TweenLite.set($('#home-text-1'), { opacity: 0 });
    TweenLite.set($('#home-text-2'), { opacity: 0 });
    TweenLite.set($('#home-jayel'), { opacity: 0, y: -50 });
    TweenLite.set($('#home-platform'), { opacity: 0, y: 50 });
    TweenLite.set($('#desk-text-1'), { opacity: 0 });
    TweenLite.set($('#desk-text-2'), { opacity: 0 });
    ...
    TweenLite.set($('#tabletop-text-2'), { opacity: 0 });
